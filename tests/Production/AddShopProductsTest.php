...
{
    public function test_add_shop_products_with_production_database()
    {
        ...
        $addShopProducts = new AddShopProducts($shop->uuid, '6bc49b47-89af-44de-a15e-4926cf0af8e9', $shop->configuration_uuid);

       iterator_to_array($addShopProducts->addShopProducts(), false);
