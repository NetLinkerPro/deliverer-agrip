...
namespace NetLinker\DelivererAgrip\Sections\Formatters\Repositories;
...
class FormatterRepository extends BaseRepository
{
    ...
    public function scope($request)
    {
        ...
        // apply custom scopes
        $this->entity = (new FormatterScopes($request))->scope($this->entity);
