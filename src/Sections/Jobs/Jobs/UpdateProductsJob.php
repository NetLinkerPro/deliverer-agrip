...
class UpdateProductsJob implements ShouldQueue
{
    ...
    public function __construct($params = [])
    {
        ...
        $this->prepareStatus(['name' =>  __('deliverer-agrip::jobs.update_products', ['name' => config('deliverer-agrip.name')])]);
    ...
    public function handle()
    {
        ...
        $service = new UpdateProducts(function($message){
            $this->addLog($message);
        });

        $steps = $service->updateProducts();
