...
class UpdateMyPricesStocksJob implements ShouldQueue
{
    ...
    public function __construct($params = [])
    {
        ...
        $this->auth($params['owner_uuid']);
        $this->prepareStatus(['name' =>  __('deliverer-agrip::jobs.update_my_prices_stocks', ['name' => config('deliverer-agrip.name')])]);
    ...
    public function handle()
    {
        ...
        $service = new UpdateMyPricesStocks($this->params['shop_uuid'], $this->params['owner_uuid'], $this->params['configuration_uuid'],function($message){
            $this->addLog($message);
        });

        $steps = $service->updateMyPricesStocks();
