...
class EkspertWebsiteClient implements WebsiteClient
{
    ...
    private function getCookiesLogin(bool $forceLogin = false): CookieJar
    {
        ...
        return Cache::remember($keyCache, 3600, function () {
            $client = $this->getClientAnonymous();
            $response = $client->post('https://b2b.agrip.pl/?continue=https://b2b.agrip.pl/start', $this->getDefaultOptions([
                RequestOptions::FORM_PARAMS => [
                    'continue' => 'https://b2b.agrip.pl/start',
                    'user' => $this->login,
