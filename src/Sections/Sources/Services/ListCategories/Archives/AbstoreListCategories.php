...
class AbstoreListCategories implements ListCategories
{
...
//        $categories = $this->getCategories();
    ...
    private function getMainCategoriesWebsite(): array
    {
        ...
        $html = $crawler->html();
        $categories = [];
        $crawler->filter('li.abs-mega-menu-links-box a')->each(function (Crawler $aElement) use (&$categories) {
    ...
    {
        $content = $this->websiteClient->getContents('https://agrip.abstore.pl');
