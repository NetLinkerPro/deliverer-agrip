...
class FormatterRange extends Model implements OwnableContract
{
     ...
     * @var string
     */
    protected $table = 'deliverer_agrip_formatter_ranges';
     ...
     * @var array
     */
    public $fillable = ['uuid', 'owner_uuid','formatter_uuid' , 'range', 'actions'];
