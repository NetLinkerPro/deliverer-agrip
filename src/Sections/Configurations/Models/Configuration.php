...
namespace NetLinker\DelivererAgrip\Sections\Configurations\Models;
...
class Configuration extends Model implements OwnableContract
{
     ...
     * @var string
     */
    protected $table = 'deliverer_agrip_configurations';
     ...
     * @var array
     */
    public $fillable = ['uuid', 'owner_uuid', 'name', 'url_1', 'url_2', 'login', 'pass', 'login2', 'pass2', 'token', 'debug', 'baselinker'];

    public $orderable = [];

    protected $encryptable = ['pass','pass2', 'token'];
